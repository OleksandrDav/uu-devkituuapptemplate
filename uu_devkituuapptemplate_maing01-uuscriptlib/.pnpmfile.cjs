...
function readPackage(pkg) {
  ...
  if (pkg.name === projectPkg.name) {
    // hide uuAppg01Devkit dependency from package.json of script library (needed because of jest.config.js requires configuration from uu_appg01_devkit module).
    pkg.devDependencies.uu_appg01_devkit = "^1.0.0";
  }
