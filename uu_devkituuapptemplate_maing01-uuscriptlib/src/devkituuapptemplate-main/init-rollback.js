...
const Names = {
  ...
  SCRIPT_NAME: "DevKitUuAppTemplateMainInitRollback",
};
/*@@viewOff:names*/
...
/*@@viewOn:scriptClient*/
class DevKitUuAppTemplateMainInitRollbackClient {
  ...
  async initFinalizeRollback() {
    return this.DevKitUuAppTemplateClient.initFinalizeRollback(this.lockSecret);
  }
}
/*@@viewOff:scriptClient*/

/*@@viewOn:validateDtoIn*/
const DtoInValidationSchema = `const scriptDevKitUuAppTemplateMainInitRollbackDtoInType = shape({
...
function validateDtoIn(dtoIn, uuAppErrorMap = {}) {
  ...
  let validationResult = dtoInValidator.validate("scriptDevKitUuAppTemplateMainInitRollbackDtoInType", dtoIn);
...
async function main() {
  await console.info(`Script uuDevKitUuAppTemplate initRollback started`);
  dtoOut.dtoIn = dtoIn;
  ...
  let mainContext = new DevKitUuAppTemplateMainInitRollbackClient(dtoIn.lockSecret);
  ...
  uuDevKitUuAppTemplate = await mainContext.initFinalizeRollback();
