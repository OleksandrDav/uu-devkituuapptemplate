...
const InternalWorkspaceDetail = createVisualComponent({
  //@@viewOn:statics
      ...
      <UuActivity.ActivityListProvider>
        {artifactDto.data ? (
          <UuEcc.PageManagement.ProviderWithRts
            ...
            entityType="uuDevKitUuAppTemplate"
            historyType="none"
...
// const WorkspaceDetail = withRouteParamsProvider(InternalWorkspaceDetail, { oid: DataTypes.string });

//@@viewOn:exports
export { InternalWorkspaceDetail };
export default InternalWorkspaceDetail;
//@@viewOff:exports
