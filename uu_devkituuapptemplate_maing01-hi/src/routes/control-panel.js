...
let ControlPanel = createVisualComponent({
  ...
  render(props) {
    ...
    } else if (data?.authorizationData?.artifact) {
      territoryBaseUri = data.authorizationData.artifact.uuTerritoryBaseUri;
      artifactId = data.authorizationData.artifact.artifactId;
      child = (
